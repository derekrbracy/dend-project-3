"""
This module contains SQL queries to drop and create tables, copy data from S3 to staging tables
in Redshift and insert data from staging tables to analytics tables.
"""
import configparser
